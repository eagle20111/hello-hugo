...
![TensorRT_Inference](https://github.com/jianye0428/hello-hugo/raw/master/img/posts/notes/2022-04-24_TensorRT/TensorRT-Inference.jpg)
...
![TensorRT_Optimization](https://github.com/jianye0428/hello-hugo/raw/master/img/posts/notes/2022-04-24_TensorRT/TensorRT-Optimization.png)
...
![TensorRT_Optimization](https://github.com/jianye0428/hello-hugo/raw/master/img/posts/notes/2022-04-24_TensorRT/TensorRT-ONNX-workflow.png)


tensorRT中有一个 Plugin 层，这个层提供了 API 可以由用户自己定义tensorRT不支持的层。
TensorRT-plugin
![TensorRT_Plugin](https://github.com/jianye0428/hello-hugo/raw/master/img/posts/notes/2022-04-24_TensorRT/TensorRT-plugin.png)
...
![TensorRT-optimize-method](https://github.com/jianye0428/hello-hugo/raw/master/img/posts/notes/2022-04-24_TensorRT/TensorRT-optimize-method.png)
...
- **层间融合或张量融合(Layer & Tensor Fusion)**
    ...
    ![TensorRT-layer-fusion](https://github.com/jianye0428/hello-hugo/raw/master/img/posts/notes/2022-04-24_TensorRT/TensorRT-layer-fusion.png)
...
2. 安装cuda
   ...
   ![TensorRT-no-driver](https://github.com/jianye0428/hello-hugo/raw/master/img/posts/notes/2022-04-24_TensorRT/TensorRT-no-driver.png)
   2.3 路径设置
    ```shell
    ...
    ```
    出现如下输出，则CUDA安装成功。
    ![Tensort-cuda_install_success](https://github.com/jianye0428/hello-hugo/raw/master/img/posts/notes/2022-04-24_TensorRT/Tensort-cuda_install_success)
...
![TensorRT-custom_operator_files](https://github.com/jianye0428/hello-hugo/raw/master/img/posts/notes/2022-04-24_TensorRT/TensorRT-custom_operator_files.png)
