...
slug: ""
date: 2022-10-08T17:25:41+08:00
summary: ""
author: ["Jian"]
cover:
    image: ""
...
3. Workers 使用ring all-reduce算法来同步彼此的梯度，从而在本地所有节点上计算同样的平均梯度。
    ...
    ![Scatter Reduce](https://github.com/jianye0428/hello-hugo/raw/master/img/posts/notes/2022-10-08_Horovod_2/Horovod_2_scatter_reduce.png#center)

    3. AllGather 阶段：通过 num_devices - 1 轮通信和覆盖，将上个阶段计算出的每个 tensor 分片的和 广播到其他 device；最终所有节点都拥有所有tensor分片和。具体如下：
    ![Allgather](https://github.com/jianye0428/hello-hugo/raw/master/img/posts/notes/2022-10-08_Horovod_2/Horovod_2_allgather.png#center)
...
![HOROVOD INIT LOGIC](https://github.com/jianye0428/hello-hugo/raw/master/img/posts/notes/2022-10-08_Horovod_2/Horovod_2_init_logic.png#center)
